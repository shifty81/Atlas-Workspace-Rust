#!/usr/bin/env bash
# ╔════════════════════════════════════════════════════════════════╗
# ║  ⚠  LEGACY C++ BUILD — Reference Implementation Only         ║
# ║  The PRIMARY build system is Rust/Cargo.                      ║
# ║  For Rust: bash Scripts/build_rust.sh                         ║
# ║  For the game: cargo run --bin atlas-game                     ║
# ║  For the editor: cargo run --bin atlas-workspace              ║
# ╚════════════════════════════════════════════════════════════════╝
# ╔══════════════════════════════════════════════════════════════════╗
